...
import { startApp, killApp, listApps, killAllChildren, children, readApp, writeApp } from "./localModules/commandments/processControl.js";
...
ipcMain.handle("write-app", (_e, args) => {
    return writeApp(args);
});
